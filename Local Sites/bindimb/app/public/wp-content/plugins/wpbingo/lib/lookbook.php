...
define ( 'POLARIVA_LOOKBOOK_PLUGIN_DIR', untrailingslashit( dirname( __FILE__ ) ) );
define ( 'POLARIVA_LOOKBOOK_PLUGIN_URL', untrailingslashit( plugins_url( '', __FILE__ ) ) );
define ( 'LOOKBOOK_UPLOAD_URL_IMAGE', POLARIVA_LOOKBOOK_PLUGIN_URL . '/lookbook/images');
define ( 'LOOKBOOK_UPLOAD_URL_THUMB', POLARIVA_LOOKBOOK_PLUGIN_URL . '/lookbook/images/'.UPLOAD_FOLDER_NAME_THUMB);
define ( 'LOOKBOOK_UPLOAD_PATH_IMAGE', POLARIVA_LOOKBOOK_PLUGIN_DIR . '/lookbook/images');
define ( 'LOOKBOOK_UPLOAD_PATH', POLARIVA_LOOKBOOK_PLUGIN_DIR . '/lookbook/images/' . UPLOAD_FOLDER_NAME);
define ( 'LOOKBOOK_UPLOAD_PATH_ORIG', POLARIVA_LOOKBOOK_PLUGIN_DIR . '/lookbook/images/' . UPLOAD_FOLDER_NAME_ORIG);
define ( 'LOOKBOOK_UPLOAD_PATH_THUMB', POLARIVA_LOOKBOOK_PLUGIN_DIR . '/lookbook/images/' . UPLOAD_FOLDER_NAME_THUMB);
...
function lookbook_style(){
	if (!wp_style_is('bwp_lookbook_css')) {
		wp_register_style( 'bwp_lookbook_css', plugins_url('/polariva/assets/css/bwp_lookbook.css') );
		wp_enqueue_style('bwp_lookbook_css');
	}	
}

function lookbook_add_menu() {
	add_submenu_page( 'polariva', esc_html__( 'LookBook', 'polariva' ), esc_html__( 'LookBook', 'polariva' ), 'manage_options', 'lookbook', 'bwp_dashboard');
}

if ( is_admin() ) {
    if( current_user_can('manage_options') ){
        require_once POLARIVA_LOOKBOOK_PLUGIN_DIR . '/lookbook/admin/admin.php';
    }
}
