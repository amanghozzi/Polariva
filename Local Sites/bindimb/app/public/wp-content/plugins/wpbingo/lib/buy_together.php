<?php
	require_once POLARIVA_CONTENT_TYPES_LIB . 'buy-together/menu-scripts-styles.php';
	require_once POLARIVA_CONTENT_TYPES_LIB . 'buy-together/helpers.php';
	require_once POLARIVA_CONTENT_TYPES_LIB . 'buy-together/load-products-data.php';
	require_once POLARIVA_CONTENT_TYPES_LIB . 'buy-together/backend.php';
	require_once POLARIVA_CONTENT_TYPES_LIB . 'buy-together/frontend.php';
	add_filter( 'woocommerce_product_data_tabs', 'product_data_tabs');
	add_action( 'woocommerce_product_data_panels', 'product_data_panels' );
	add_action( 'woocommerce_process_product_meta_simple','process_product_meta_polariva');

	function product_data_tabs( $tabs ) {
		$tabs['polariva'] = array(
			'label'  => esc_html__( 'Buy Together', 'polariva' ),
			'target' => 'bwp_settings',
	...
	function product_data_panels() {
		...
		<div id='bwp_settings' class='panel woocommerce_options_panel buy-together-table-wrap'>
			...
			<table class="buy-together-table">
				...
				<tr>
					<td width="250"><?php esc_html_e( 'Selected', 'polariva' ); ?></td>
					<td>
						<div class="buy-together-inner-wrapper">
	 ...
	 */
	function process_product_meta_polariva( $post_id ) {
