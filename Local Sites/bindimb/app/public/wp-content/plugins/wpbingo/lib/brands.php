<?php
/**
 * Polariva Woo Tab Slider Widget
 * Plugin URI: http://www.polariva.com
 * Version: 1.0
 */
if ( ! defined( 'ABSPATH' ) ) {
	exit; 
...
class bwp_brands_WC_Admin_Taxonomies {
	...
	public function bwp_woocommerce_brands_metabox( $post ) {
		...
		<div id="taxonomy-<?php echo $taxonomy; ?>" class="bwp_brands">
			...
			<ul id="<?php echo $taxonomy; ?>-tabs" class="brands-tabs">
				...
				<li class="hide-if-no-js"><a href="#<?php echo $taxonomy; ?>-pop" tabindex="3"><?php _e( 'Most Used','polariva' ); ?></a></li>
			</ul>
	...
	public function create_taxonomies() {
		...
		$labels = array(
			'name'              => __( 'Brands', 'polariva' ),
			'singular_name'     => __( 'Brands', 'polariva' ),
			'search_items'      => __( 'Search Genres', 'polariva' ),
			'all_items'         => __( 'All Brands', 'polariva' ),
			'parent_item'       => __( 'Parent Brands', 'polariva'),
			'parent_item_colon' => __( 'Parent Brands:', 'polariva' ),
			'edit_item'         => __( 'Edit Brands', 'polariva'),
			'update_item'       => __( 'Update Brands', 'polariva'),
			'add_new_item'      => __( 'Add New Brands', 'polariva'),
			'new_item_name'     => __( 'New Brands Name', 'polariva'),
			'menu_name'         => 'Brand',
		);
		...
		$args = array(
			...
			'rewrite' 				=> array( 'slug' => $brands_base . __( 'brand', 'polariva' ), 'with_front' => false, 'hierarchical' => true )
		);
	...
	public function add_brands_fields() {
		...
		?>
		<div class="">
			<label for="display_type"><?php _e( 'Featured', 'polariva' ); ?></label>
	...
	public function edit_brands_fields( $term, $taxonomy ) {
		...
		?>
		<tr class="">
			<th scope="row" valign="top"><label><?php _e( 'Featured', 'polariva' ); ?></label></th>
			<td>
