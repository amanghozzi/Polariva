<?php $j = 0; ?>
<div class="bwp-instagram <?php if(!empty($show_clipped)) echo 'clipped-content-show'; ?> <?php if ($show_nav !== 'false') { echo esc_attr($navigational_style);} ?> <?php echo esc_attr($layout); ?>">
 <div class="block">
	...
	<div class="block_content">
		<div class="instagram">
			<div class="slick-carousel" data-autoplay="<?php echo esc_attr($show_autoplay);?>" data-dots="<?php echo esc_attr($show_pag);?>" data-item_row="<?php echo esc_attr($item_row); ?>" data-nav="<?php echo esc_attr($show_nav);?>" data-columns4="<?php echo esc_attr($columns4); ?>" data-columns3="<?php echo esc_attr($columns3); ?>" data-columns2="<?php echo esc_attr($columns2); ?>" data-columns1="<?php echo esc_attr($columns1); ?>" data-columns="<?php echo esc_attr($columns); ?>">
