...
?>
<div class="bwp-filter-homepage tab-product slider <?php if(!empty($show_clipped)) echo 'clipped-content-show'; ?> <?php if(!empty($show_dividers)) echo 'tab-dividers'; ?> <?php echo esc_attr($layout); ?> <?php if ($show_nav !== 'false') { echo esc_attr($navigational_style);} ?>" <?php if($style_product > 1) { ?>data-content_product="<?php echo esc_attr($style_product) ?>"<?php } ?>  data-numberposts = "<?php echo esc_attr($numberposts); ?>">
	<div class="bwp-filter-heading">
		...
		<div class="filter-order-by">
			<ul class="filter-orderby title-position-<?php echo esc_attr($position);?>">
