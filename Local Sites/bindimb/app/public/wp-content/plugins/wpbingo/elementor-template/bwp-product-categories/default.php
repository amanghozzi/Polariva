									...
									<div class="info">
										...
										<?php if(isset($show_count) && $show_count) : ?>
											<div class="item-count">
												<?php
													if ($term->count == 1) {
														echo esc_attr($term->count) . '<span>' . esc_html__(' product', 'wpbingo') . '</span>';
													} elseif ($term->count > 1) {
														echo esc_attr($term->count) . '<span>' . esc_html__(' products', 'wpbingo') . '</span>';
													} else {
														echo esc_html__('0 product', 'wpbingo');
													}
												?>
											</div>
										<?php endif;?>
