...
?>
<div class="bwp-filter-homepage tab-product <?php echo esc_attr($layout); ?> <?php if(!empty($show_dividers)) echo 'tab-dividers'; ?>" <?php if($style_product > 1) { ?>data-content_product="<?php echo esc_attr($style_product) ?>"<?php } ?> data-class_col = "<?php echo esc_attr($class_col); ?>" data-numberposts = "<?php echo esc_attr($numberposts); ?>">
