	...
	<div id="<?php echo $widget_id; ?>" class="bwp-countdown <?php echo esc_attr($layout); ?>">       
		...
		<div class="content-product-list">	
			...
			<?php while($list->have_posts()): $list->the_post();?>
				...
				$product_hot_label = isset($bemins_settings['product-hot-label']) && !empty($bemins_settings['product-hot-label']) ? $bemins_settings['product-hot-label'] : esc_html__('Hot','wpbingo');
