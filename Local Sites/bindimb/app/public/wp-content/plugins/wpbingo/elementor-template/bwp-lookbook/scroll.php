<?php
	...
	<div class="bwp-lookbook scroll-list <?php echo esc_attr($layout); ?>">
		<div class="box-title">
		...
		<div class="cover-content">
			<div class="list-lookbook" data-columns4="<?php echo $columns4; ?>" data-columns3="<?php echo $columns3; ?>" data-columns2="<?php echo $columns2; ?>" data-columns1="<?php echo $columns1; ?>" data-columns="<?php echo $columns; ?>" >
