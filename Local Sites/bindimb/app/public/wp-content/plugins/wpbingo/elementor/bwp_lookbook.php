...
class Bwp_Lookbook extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'scroll'   => __( 'Instagram Scroll', 'wpbingo' )
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_responsive_control(
			'background',
			[
				'label' => esc_html__( 'Background', 'wpbingo' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bwp-lookbook .button' => 'background: {{VALUE}};',
				],
				'condition' => [],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bwp-lookbook .button:hover, {{WRAPPER}} .bwp-lookbook .button:focus' => 'background: {{VALUE}};',
				],
				'condition' => [],
			]
		);
	...
	protected function render() {
		...
		if( $layout == 'default' ){
			...
			include(WPBINGO_ELEMENTOR_TEMPLATE_PATH.'bwp-lookbook/scroll.php' );
		}
	}
}
