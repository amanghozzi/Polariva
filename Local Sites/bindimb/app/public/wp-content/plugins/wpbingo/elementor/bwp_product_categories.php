...
class Bwp_Product_Categories extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => '1',
				'condition'   => [
                    'layout' => ["slider","slider-fraction",'slider-fraction-2','slider-fraction-3'],
                ]				
			]
		);		
		$this->add_control(
			...
			[
				...
				'default' => '0',
				'condition'   => [
                    'layout' => ["default","slider","slider-fraction",'slider-fraction-2','slider-fraction-3'],
                ]
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'slider-fraction' 		=> __( 'Slider Fraction', 'wpbingo' ),
					'slider-fraction-2' 		=> __( 'Slider Fraction 2', 'wpbingo' ),
					'slider-fraction-3' 		=> __( 'Slider Fraction 3', 'wpbingo' )
				],
			]
		);		
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories .bwp-categories-title' => 'font-family: {{VALUE}};',
				],
				'condition'   => [
                    'font_custom_title!' => '',
                ]
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories .bwp-categories-title' => 'text-align: {{VALUE}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories .bwp-categories-description' => 'color: {{VALUE}};',
				],
				'global' => [
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bwp-woo-categories .bwp-categories-description',
				'global' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories .bwp-categories-description' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories .slick-list' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories .slick-slide' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
	...
	protected function render() {
		...
		}elseif($layout == 'slider-fraction' || $layout == 'slider-fraction-2' || $layout == 'slider-fraction-3'){
			include( WPBINGO_ELEMENTOR_TEMPLATE_PATH.'bwp-product-categories/slider-fraction.php' );
		}
	}
}
