...
class Plugin {
	...
	public function register_widgets() {
		...
		\Elementor\Plugin::instance()->widgets_manager->register( new Widgets\Bwp_Marquee_Text() );
		\Elementor\Plugin::instance()->widgets_manager->register( new Widgets\Bwp_Products_Slideshow() );
	}
