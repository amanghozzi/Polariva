...
class Bwp_WP_Nav_Menu_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		$class_vertical = bemins_dropdown_vertical_menu();
		// Get menu
		...
		<div class="categories-vertical-menu <?php echo esc_attr($class_vertical); ?>"
			...
			data-max_number_1530="<?php echo esc_attr(bemins_limit_verticalmenu()->max_number_1530); ?>" 
			data-max_number_1200="<?php echo esc_attr(bemins_limit_verticalmenu()->max_number_1200); ?>" 
			data-max_number_991="<?php echo esc_attr(bemins_limit_verticalmenu()->max_number_991); ?>">
