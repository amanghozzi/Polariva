<?php
	 ...
	 * @version     1.0.0
	 **/
	global $wp_query,$bemins_settings;
	...
	if($paged > 1 && $tax_name != "product_cat" && $shop_paging == "shop-pagination"){
		$link .= 'page/'.$paged;
	}
	if( $tax_name == "product_cat" ){
		if( $id_taxonomy == 0 ){
			if($paged > 1 &&  $shop_paging == "shop-pagination"){
				$base_url .= 'page/'.$paged;
				$link = $base_url;
			}else{
				$link = $base_url;
			...
			$base_url = get_category_link( (int)$id_taxonomy );
			if($paged > 1 &&  $shop_paging == "shop-pagination"){
				$base_url .= 'page/'.$paged;
				$link = $base_url;
			}else{
