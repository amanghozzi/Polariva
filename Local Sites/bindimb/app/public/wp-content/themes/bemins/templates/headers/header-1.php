<?php 
	...
	if(get_theme_mod('header_order_1')){
		...
		$header_order_1 = 'logo-menu-icons';
...
<header id='bwp-header' class="bwp-header header-v1<?php if(get_theme_mod('header_absolute_1',true)) { ?> header-absolute<?php } ?>">
	<?php bemins_campbar(); ?>
				...
				<div class="container">
					<div class="topbar-container">
						<?php foreach ($arr_topbar_order as $value) { 
							switch ($value) {
							case 'topbar1': ?>
								<?php if(get_theme_mod('content_left_top_bar_1', 'content topbar 1')) { ?>
									<div class="topbar-left">
										<?php echo get_theme_mod('content_left_top_bar_1', 'content topbar 1'); ?>
									</div>
								<?php } ?>
							<?php break;
							case 'topbar2': ?>
							...
							<?php break;
							case 'topbar3': ?>
								<?php if(get_theme_mod('content_right_top_bar_1', 'content topbar 3')) { ?>
									<div class="topbar-right">
										<?php echo get_theme_mod('content_right_top_bar_1', 'content topbar 3'); ?>
									</div>
								<?php } ?>
							<?php break;
							case 'social': ?>
	...
	<div class="header-desktop">
		<div class='header-wrapper' data-sticky_header="<?php echo esc_attr($bemins_settings['enable-sticky-header']); ?>">
			<div class="container">
				<div class="header-container <?php echo esc_attr($header_order_1); ?> <?php echo get_theme_mod('menu_pos_1','menu-center'); ?>">
