					...
					<div class="entry-meta-head">
						<?php if (bemins_get_config('archives-author')) { ?>
							<div class="entry-author">
								<span class="entry-meta-link"><?php echo esc_html__("By ",'bemins') ?><?php echo the_author_posts_link(); ?> <?php echo esc_html__("on ",'bemins') ?><?php bemins_posted_on_2(); ?></span>
							</div>
						<?php } ?>
					</div>
				</div>
