<?php 
	...
	if(get_theme_mod('header_order_2')){
		...
		$header_order_2 = 'menu-logo-icons';
...
?>
<header id='bwp-header' class="bwp-header header-v2<?php if(get_theme_mod('header_absolute_2',true)) { ?> header-absolute<?php } ?>">
	<?php bemins_campbar(); ?>
	<?php if(get_theme_mod('top_bar_2', false)) { ?>
	...
	<div class="header-desktop">
		<div class='header-wrapper' data-sticky_header="<?php echo esc_attr($bemins_settings['enable-sticky-header']); ?>">
			<div class="container">
				<div class="header-container <?php echo esc_attr($header_order_2); ?> <?php echo get_theme_mod('menu_pos_2','menu-left'); ?>">
					<?php foreach ($arr_header_order as $value) {
						switch ($value) {
							...
							<?php break;
							case 'logo': ?>
								<div class="header-logo <?php echo get_theme_mod('logo_pos_2', 'text-center'); ?>">
