...
?>
<header id='bwp-header' class="bwp-header header-v3<?php if(get_theme_mod('header_absolute_3',false)) { ?> header-absolute<?php } ?>">
	<?php bemins_campbar(); ?>
	<?php if(get_theme_mod('top_bar_3', false)) { ?>
				...
				<div class="container">
					<div class="topbar-container">
						<?php foreach ($arr_topbar_order as $value) { 
							switch ($value) {
							case 'topbar1': ?>
								<?php if(get_theme_mod('content_left_top_bar_3', true)) { ?>
									<div class="topbar-left">
										<?php echo get_theme_mod('content_left_top_bar_3', ''); ?>
									</div>
								<?php } ?>
							<?php break;
							case 'topbar2': ?>
							...
							<?php break;
							case 'topbar3': ?>
								<?php if(get_theme_mod('content_right_top_bar_3', true)) { ?>
	...
	<div class="header-desktop">
		<div class='header-wrapper' data-sticky_header="<?php echo esc_attr($bemins_settings['enable-sticky-header']); ?>">
			<div class="container">
				<div class="header-container <?php echo esc_attr($header_order_3); ?> <?php echo get_theme_mod('menu_pos_3','menu-left'); ?>">
							...
							case 'icons': ?>
								<?php if(($show_account || $show_minicart || $show_wishlist || $show_searchform) && class_exists( 'WooCommerce' ) ){ ?>
									<div class="header-icon">
										<div class="header-page-link <?php echo get_theme_mod('icons_pos_3', 'text-right'); ?>">
											<!-- Begin Search -->
