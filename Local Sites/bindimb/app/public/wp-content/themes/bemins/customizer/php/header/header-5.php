<?php ///////////////HEADER 5
				...
				<div class="bwp-drop-control">
					...
					<div class="bwp-drag-dropdown_content">
						...
						<div class="bwp-drag-drop-content bwp-drag-drop-toggle" data-value="topbar1">
							<div class="cus-label" style="margin-bottom:20px;"><?php echo esc_html__('Content','bemins'); ?></div>
					...
					<div class="bwp-drag-dropdown_content">
						<div class="bwp-drag-drop-content bwp-drag-drop-toggle" data-value="logo">
							...
							<div class="drag-option">
								...
								<select class="bwp-select" <?php $this->link('logo_pos_5'); ?>>
						...
						<div class="bwp-drag-drop-content bwp-drag-drop-toggle" data-value="menu">
							...
							<div class="drag-option">
								...
								<select class="bwp-select" <?php $this->link('menu_pos_5'); ?>>
						...
						<div class="bwp-drag-drop-content bwp-drag-drop-toggle" data-value="icons">
							<div class="drag-option">
								...
								<input type="text" class="bwp-input-color" data-default-color="" value="<?php echo esc_attr($this->value('icon_color_5')); ?>" <?php $this->link('icon_color_5'); ?> />
							</div>
							<div class="drag-option">
								<div class="cus-label"><?php echo esc_html__('Show icon cart','bemins'); ?></div>
								<div class="switch-options">
									<input type="checkbox" value="<?php echo esc_attr($this->value('icon_cart_5')); ?>" <?php $this->link('icon_cart_5'); ?>>
									<label class="disable"></label>
								</div>
							</div>
							<div class="drag-option">
								...
								<div class="switch-options">
									<input type="checkbox" value="<?php echo esc_attr($this->value('icon_search_5')); ?>" <?php $this->link('icon_search_5'); ?>>
									<label class="disable"></label>
								</div>
							</div>
							<div class="drag-option">
								...
								<div class="switch-options">
									<input type="checkbox" value="<?php echo esc_attr($this->value('icon_account_5')); ?>" <?php $this->link('icon_account_5'); ?>>
									<label class="disable"></label>
								</div>
							</div>
							<div class="drag-option">
								...
								<div class="switch-options">
									<input type="checkbox" value="<?php echo esc_attr($this->value('icon_wishlist_5')); ?>" <?php $this->link('icon_wishlist_5'); ?>>
									<label class="disable"></label>
								</div>
							</div>
							<div class="drag-option">
								<span class="customize-control-title"><?php echo esc_html__('Icons position','bemins'); ?></span>
								<select class="bwp-select" <?php $this->link('icons_pos_5'); ?>>
									<option value="text-left"><?php echo esc_html__('Left','bemins'); ?></option>
									<option value="text-right"><?php echo esc_html__('Right','bemins'); ?></option>
									<option value="text-center"><?php echo esc_html__('Center','bemins'); ?></option>
								</select>
	...
	$wp_customize->add_setting( 'logo_pos_5' , array(
		'default' => 'text-left',
		'sanitize_callback' => 'sanitize_input',
		'transport' => 'postMessage', 
	));
	...
	$wp_customize->add_setting( 'menu_pos_5' , array(
		'default' => 'menu-left',
		'sanitize_callback' => 'sanitize_input',
		'transport' => 'postMessage', 
	));
	...
	$wp_customize->add_setting( 'icon_cart_5' , array(
		'default' => true,
		'sanitize_callback' => 'sanitize_input',
	));
	$wp_customize->add_setting( 'icon_search_5' , array(
		'default' => true,
		'sanitize_callback' => 'sanitize_input',
	));
	$wp_customize->add_setting( 'icon_wishlist_5' , array(
		'default' => true,
		'sanitize_callback' => 'sanitize_input', 
	));
	$wp_customize->add_setting( 'icon_account_5' , array(
		'default' => true,
		'sanitize_callback' => 'sanitize_input',
	));
	$wp_customize->add_setting( 'icons_pos_5' , array(
		'default' => 'text-right',
		'sanitize_callback' => 'sanitize_input',
		'transport' => 'postMessage', 
	));
	$wp_customize->add_control( new Header_order_5( $wp_customize, 'header_order_5', array(
		...
		'settings' => [
			...
			'logo_pos_5' => 'logo_pos_5',
			'icons_pos_5' => 'icons_pos_5',
			'menu_color_5' => 'menu_color_5',
			'menu_size_5' => 'menu_size_5',
			'menu_pos_5' => 'menu_pos_5',
			'icon_color_5' => 'icon_color_5',
			'icon_cart_5' => 'icon_cart_5',
			'icon_search_5' => 'icon_search_5',
			'icon_wishlist_5' => 'icon_wishlist_5',
			'icon_account_5' => 'icon_account_5',
		],
	)));
