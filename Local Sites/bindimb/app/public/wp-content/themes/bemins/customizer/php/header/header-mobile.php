<?php ///////////////HEADER MOBILE
	...
	class Topbar_mobile extends WP_Customize_Control{
		...
		public function render_content(){ ?>
			<div class="bwp-cus-title"><?php echo esc_html__('1.HEADER TOP','bemins') ?></div>
			<div class="filed-flex">
				<div class="cus-label"><?php echo esc_html__('Show topbar in mobile','bemins') ?></div>
	...
	class Header_moble_bottom extends WP_Customize_Control{
		...
		public function render_content(){ ?>
			<div class="filed-flex">
				<div class="bwp-cus-title" style="margin-top:40px;"><?php echo esc_html__('2.HEADER BOTTOM','bemins') ?></div>
				<div class="filed-flex" style="margin-bottom:20px;">
					<div class="cus-label"><?php echo esc_html__('Show menu bottom','bemins') ?></div>
					<div class="switch-options">
	...
	class Header_moble_menu extends WP_Customize_Control{
		...
		public function render_content(){ ?>
			<div class="bwp-cus-title" style="margin-top:40px;"><?php echo esc_html__('3.MENU MOBILE','bemins') ?></div>
		<?php }
	}
	...
	class Header_login_moble extends WP_Customize_Control{
		...
		public function render_content(){ ?>
			<div class="filed-flex">
				<div class="cus-label"><?php echo esc_html__('Show login or register','bemins') ?></div>
				<div class="switch-options">
