...
<?php } ?>
<?php if(get_theme_mod('size_label_1', '')) { ?>
	.products-list.grid .content-product1 .product-lable .hot{
		font-size: <?php echo get_theme_mod('size_label_1', ''); ?>px;
	}
	.products-list.grid .content-product1 .product-lable .onsale{
		font-size: <?php echo get_theme_mod('size_label_1', ''); ?>px;
	}
<?php } ?>
<?php if(get_theme_mod('color_pre_1', '')) { ?>
	.products-list.grid .content-product1 .product-stock .stock{
		color: <?php echo get_theme_mod('color_pre_1', ''); ?>;
	}
<?php } ?>
<?php if(get_theme_mod('background_pre_1', '')) { ?>
	.products-list.grid .content-product1 .product-stock{
		background: <?php echo get_theme_mod('background_pre_1', ''); ?>;
	}
<?php } ?>
<?php if(get_theme_mod('size_pre_1', '')) { ?>
	.products-list.grid .content-product1 .product-stock .stock{
		font-size: <?php echo get_theme_mod('size_pre_1', ''); ?>px;
	}
<?php } ?>
...
<?php } ?>
<?php if(get_theme_mod('size_label_2', '')) { ?>
	.products-list.grid .content-product2 .product-lable .hot{
		font-size: <?php echo get_theme_mod('size_label_2', ''); ?>px;
	}
	.products-list.grid .content-product2 .product-lable .onsale{
		font-size: <?php echo get_theme_mod('size_label_2', ''); ?>px;
	}
<?php } ?>
<?php if(get_theme_mod('color_pre_2', '')) { ?>
	.products-list.grid .content-product2 .product-stock .stock{
		color: <?php echo get_theme_mod('color_pre_2', ''); ?>;
	}
<?php } ?>
<?php if(get_theme_mod('background_pre_2', '')) { ?>
	.products-list.grid .content-product2 .product-stock{
		background: <?php echo get_theme_mod('background_pre_2', ''); ?>;
	}
<?php } ?>
<?php if(get_theme_mod('size_pre_2', '')) { ?>
	.products-list.grid .content-product2 .product-stock .stock{
		font-size: <?php echo get_theme_mod('size_pre_2', ''); ?>px;
	}
<?php } ?>
...
<?php if(get_theme_mod('size_label_3', '')) { ?>
	.products-list.grid .content-product3 .product-lable .hot{
		font-size: <?php echo get_theme_mod('size_label_3', ''); ?>px;
	}
	.products-list.grid .content-product3 .product-lable .onsale{
		font-size: <?php echo get_theme_mod('size_label_3', ''); ?>px;
	}
<?php } ?>
<?php if(get_theme_mod('color_pre_3', '')) { ?>
	.products-list.grid .content-product3 .product-stock .stock{
		color: <?php echo get_theme_mod('color_pre_3', ''); ?>;
	}
<?php } ?>
<?php if(get_theme_mod('background_pre_3', '')) { ?>
	.products-list.grid .content-product3 .product-stock{
		background: <?php echo get_theme_mod('background_pre_3', ''); ?>;
	}
<?php } ?>
<?php if(get_theme_mod('size_pre_3', '')) { ?>
	.products-list.grid .content-product3 .product-stock .stock{
		font-size: <?php echo get_theme_mod('size_pre_3', ''); ?>px;
	}
<?php } ?>
