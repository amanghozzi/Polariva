		...
		<?php if( get_theme_mod('gray_dark', '') || get_theme_mod('theme_color', '') || get_theme_mod('text_color', '') || get_theme_mod('button_color', '') || get_theme_mod('border_color', '')  || get_theme_mod('hover_color', '') || get_theme_mod('font_family_base', '') || get_theme_mod('font_family_heading', '') || get_theme_mod('font_size_heading', '') || get_theme_mod('font_size_body', '') ) { ?>
			...
			:root {
				<?php if(get_theme_mod('gray_dark', '')) { ?>
					...
					--gray-dark-5:<?php echo get_theme_mod('gray_dark', ''); ?>7F;
					...
					--gray-dark-40:<?php echo get_theme_mod('gray_dark', ''); ?>66;
				...
				<?php } ?>
				<?php if(get_theme_mod('hover_color', '')) { ?>
					--hover-color:<?php echo get_theme_mod('hover_color', ''); ?>;
					--hover-color-25:<?php echo get_theme_mod('hover_color', ''); ?>3f;
					--hover-color-50:<?php echo get_theme_mod('hover_color', ''); ?>7f;
					--hover-color-75:<?php echo get_theme_mod('hover_color', ''); ?>bf;
					--hover-color-80:<?php echo get_theme_mod('hover_color', ''); ?>cc;
				<?php } ?>
...
add_action( 'wp_head', 'bemins_customize_css');