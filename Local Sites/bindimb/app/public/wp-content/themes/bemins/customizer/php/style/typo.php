<?php ///////////////TYPO
	...
	class Api_key extends WP_Customize_Control{
		...
		public function render_content(){ ?>
			<div class="bwp-cus-title"><?php echo esc_html__('1.FONT BASE','bemins') ?></div>
		<?php }
	}
	...
	class Font_title2 extends WP_Customize_Control{
		...
		public function render_content(){ ?>
			<div class="bwp-cus-title" style="margin-top:40px;"><?php echo esc_html__('2.FONT HEADING','bemins') ?></div>
		<?php }
	}
