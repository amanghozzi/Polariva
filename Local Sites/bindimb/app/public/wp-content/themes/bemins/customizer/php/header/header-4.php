<?php ///////////////HEADER 4
	...
	$wp_customize->add_setting( 'topbar_order_4' , array(
		'default' => 'topbar1-topbar2-topbar3', 
		'sanitize_callback' => 'sanitize_input',
		'transport' => 'refresh', 
	));
	$wp_customize->add_setting( 'content_right_top_bar_4' , array(
		'default' => '<div class="contact hidden-xs"><a href="#">Contact Us</a></div><div class="customer"><a href="#">Customer Service</a></div>', 
		'sanitize_callback' => 'sanitize_html',
		'transport' => 'refresh',
	));
	$wp_customize->add_setting( 'content_center_top_bar_4' , array(
		'default' => '<div class="shipping hidden-xs">Autumn collection. A new season. A new perspective. <a target="_blank" href="#">Buy now!</a></div>', 
		'sanitize_callback' => 'sanitize_html',
		'transport' => 'refresh',
	));
	$wp_customize->add_setting( 'content_left_top_bar_4' , array(
		'default' => '<div class="phone">Call Us:<a href="tel:+1800 354 4321">+1800 354 4321</a></div>', 
		'sanitize_callback' => 'sanitize_html',
		'transport' => 'refresh',
	));
