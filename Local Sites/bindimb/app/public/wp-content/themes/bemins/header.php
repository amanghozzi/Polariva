...
/**
 * Version:            1.0.0
 * Theme Name:         bemins * Theme URI:          http://wpbingosite.com/themes/bemins/
 * Author:             Wpbingo
...
<?php
	$header_style  = bemins_config_header()->header_style;
	$enable_sticky_header = bemins_config_header()->enable_sticky_header;
	$show_minicart = bemins_config_header()->show_minicart;
	$show_searchform = bemins_config_header()->show_searchform;
	$background_page = bemins_config_header()->background_page;
	$checkout_page_style = bemins_config_header()->checkout_page_style;
?>
<!--<![endif]-->
<head>
							...
							<?php if($show_minicart || $show_searchform){ ?>
								...
								<div class="col-xl-2 col-lg-2 col-md-6 col-sm-6 col-6 margin-top-20">
									...
									<div class="search-box pull-right">
										...
										<div class="dropdown-search"><?php bemins_search_form_product(); ?></div>
									</div>
									<?php } ?>
									<!-- End Search -->
								</div>
