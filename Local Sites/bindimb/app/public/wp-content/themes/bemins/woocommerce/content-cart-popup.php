...
<div class="woocommerce-cart-page-popup">
	...
	<div class="woocommerce-cart-page">
		<h2><?php echo esc_html__("Your order","bemins") ?></h2>
						...
						<div class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
							<div class="content-cart-left">
								...
								<div class="product-info">
									...
									<div class="product-price" data-title="<?php esc_attr_e( "Price", "bemins" ); ?>">
										<?php
		...
		<div class="content-cart-info">
			<div class="cart-subtotal">
				<div class="title"><?php echo esc_html__( "Subtotal: ", "bemins" ); ?></div>
				<div class="cart_totals" data-title="<?php echo esc_attr__( "Subtotal", "bemins" ); ?>"><?php wc_cart_totals_subtotal_html(); ?></div>
			</div>
			<?php if($cart_free){ ?>
				<div class="free-ship">
			...
			<div class="bottom-cart">
				<div class="close-cart-popup"><?php echo esc_html__("Continue Shopping","bemins") ?></div>
