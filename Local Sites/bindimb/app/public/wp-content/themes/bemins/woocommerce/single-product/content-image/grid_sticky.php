...
$class = "";
if(bemins_image_single_product()->show_thumb && (bemins_image_single_product()->position == "left" || bemins_image_single_product()->position == "right"))
	$class = "vertical";
?>
<div class="images <?php echo esc_attr($class); ?>">
	<figure class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ); ?>">
		<div class="row">
			<?php if(bemins_image_single_product()->show_thumb && bemins_image_single_product()->position == "left") : ?>
				<div class="col-md-2">
					<?php
						/**
