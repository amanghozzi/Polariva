<?php
	...
	remove_action( 'woocommerce_single_product_summary', 'bemins_size_guide', 20 );
	remove_action( 'woocommerce_single_product_summary', 'bemins_get_countdown', 0 );
	remove_action( 'woocommerce_single_product_summary', 'bemins_count_view', 0 );
	remove_action( 'woocommerce_single_product_summary', 'woocommerce_template_single_excerpt', 0 );
	remove_action( 'woocommerce_single_product_summary', 'bemins_label_stock', 0 );
	remove_action( 'woocommerce_single_product_summary', 'bemins_get_brands', 0 );
	?>
	...
	<div class="bwp-single-info col-lg-12 col-md-12 col-12">
		<div class="summary entry-summary entry-heading">
			...
			<?php bemins_count_view(); ?>
			<?php woocommerce_template_single_excerpt(); ?>
			<?php bemins_get_countdown(); ?>
			<?php bemins_label_stock(); ?>
		</div>
