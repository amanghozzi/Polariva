						...
						<div class="content_product_detail entry-summary">
							...
							<?php
								 ...
								 */
								 ...
								 remove_action( 'woocommerce_single_product_summary', 'bemins_sigle_author_product', 40 );
								 remove_action( 'woocommerce_single_product_summary', 'bemins_size_guide', 20 );
								 remove_action( 'woocommerce_after_single_product', 'bemins_prev_next_product', 0 );
