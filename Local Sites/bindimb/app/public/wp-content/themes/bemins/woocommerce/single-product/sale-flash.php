...
$product_sale_label = isset($bemins_settings['product-sale-label']) && !empty($bemins_settings['product-sale-label']) ? $bemins_settings['product-sale-label'] : esc_html__('Sale','bemins');
?>
<?php if(isset($bemins_settings['product-sale']) && $bemins_settings['product-sale']) : ?>
