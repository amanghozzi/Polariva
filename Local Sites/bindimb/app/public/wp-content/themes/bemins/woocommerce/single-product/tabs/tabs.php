				...
				<div class="content-tab accordion">
					<?php foreach ( $product_tabs as $key => $product_tab ) : ?>
						<div class="accordion-item">
							<div class="<?php echo esc_attr( $key ); ?>_tab" role="button"  data-parent="#woocommerce-tabs-accordion" data-toggle="collapse" href="#tab-<?php echo esc_attr( $key ); ?>" id="tab-title-<?php echo esc_attr( $key ); ?>" aria-expanded="true" aria-controls="tab-<?php echo esc_attr( $key ); ?>">
