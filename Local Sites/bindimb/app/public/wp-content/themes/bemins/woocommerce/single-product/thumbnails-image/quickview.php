...
remove_action( 'woocommerce_single_product_summary', 'bemins_add_thumb_single_product', 40 );
remove_action( 'woocommerce_after_single_product', 'bemins_sticky_cart', 50 );
remove_action( 'woocommerce_single_product_summary', 'bemins_get_countdown', 20 );
remove_action( 'woocommerce_single_product_summary', 'bemins_add_social', 45 );
remove_action( 'woocommerce_single_product_summary', 'bemins_add_loop_wishlist_link', 35 );
