...
$shop_layout  			= bemins_get_config('shop-layout','boxed');
...
<div class="<?php echo esc_attr($category_style); ?><?php if($category_style == 'only_categories'){ ?> filter_sideout<?php } ?>  shop-layout-<?php echo esc_attr($shop_layout); ?>">
	...
	<?php if( function_exists('is_shop') && is_shop() && !is_search() && $category_style == 'only_categories' && apply_filters( 'bemins_custom_category', $html = '' ) ): ?>
	<div class="container">
		<div class="main-archive-product">
			<ul class="woocommerce-product-category row">
				<?php bemins_woocommerce_output_product_categories(); ?>
			</ul>
		</div>
	</div>
	<?php else: ?>
		...
		<div class="container">
			<div class="main-archive-product row">
				...
				<?php if(($category_style == 'sidebar' || $category_style == 'filter_drawer') && is_active_sidebar('sidebar-product')): ?>	
					<div class="bwp-sidebar sidebar-product <?php echo esc_attr(bemins_get_class()->class_sidebar_left); ?>">
				...
				<?php endif; ?>
				<div class="<?php echo esc_attr(bemins_get_class()->class_product_content); ?>" >
							...
							<div class="bwp-sidebar sidebar-product-filter full">
								...
								<?php if($category_style == 'filter_sideout' || $category_style == 'only_categories'): ?>
									<div class="button-filter-toggle">
										<div class="filter-close">
											<?php echo esc_html__('Close','bemins') ?>
										</div>
									</div>
								<?php endif; ?>
